...
export function StartPage({ onStart, userId }) {
  ...
  const onSubmit = (values) => {
    ...
    // Навігуємо до сторінки гри
    // useQuizEngine автоматично скине квіз при зміні налаштувань через useEffect
    navigate(`/user/${encodeURIComponent(currentUserId)}/game`, { replace: true });
  };
    ...
    <section className="page page-start">
      <header className="page-header">
        ...
        <p className="page-description">
          Налаштуйте параметри вікторини перед початком гри. Поточний
          користувач: <strong>{currentUserId}</strong>.
        </p>
      </header>
