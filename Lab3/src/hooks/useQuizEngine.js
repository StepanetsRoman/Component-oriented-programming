...
const MOCK_QUESTIONS = [
  ...
  // Додаткові питання, щоб сумарно було більше 20
  {
    id: 16,
    category: "history",
    difficulty: "hard",
  ...
  },
  {
    ...
    category: "science",
    difficulty: "hard",
    question: "Як називається процес перетворення рідкого стану речовини на газоподібний по всьому обʼєму?",
    answers: [
  ...
  },
  {
    ...
    category: "movies",
    difficulty: "easy",
    question: "Який фільм про супергероя-мільярдера в броньованому костюмі відкрив кіновсесвіт Marvel у 2008 році?",
    answers: [
